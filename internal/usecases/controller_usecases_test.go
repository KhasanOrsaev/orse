...
func (t *TestController) FindByID(ctx context.Context, id int) (*domain.Controller, error) { return &domain.Controller{ID: id}, nil }
func (t *TestController) FindByName(ctx context.Context, name string) (*domain.Controller,error) { return nil, nil }
func (t *TestDevice) SendSignal(ctx context.Context, signal int, params ...interface{}) error {	return nil }
